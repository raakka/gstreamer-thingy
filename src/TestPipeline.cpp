...
*/
void TestPipeline::Process(cv::Mat& source0){
	//Step Blur0:
	//input
	cv::Mat blurInput = source0;
	BlurType blurType = BlurType::MEDIAN;
	// double blurRadius = 3.603603603603605;  // default Double
	blur(blurInput, blurType, blurRadius, this->blurOutput);
	//Step HSV_Threshold0:
	//input
	cv::Mat hsvThresholdInput = blurOutput;
	// double hsvThresholdHue[] = {79.31654676258991, 123.17406143344711};
	// double hsvThresholdSaturation[] = {133.00359712230215, 255.0};
 ...
 */
cv::Mat* TestPipeline::GetBlurOutput(){
 ...
 */
cv::Mat* TestPipeline::GetHsvThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* TestPipeline::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* TestPipeline::GetConvexHullsOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* TestPipeline::GetFilterContoursOutput(){
	 ...
	 */
	void TestPipeline::blur(cv::Mat &input, BlurType &type, double doubleRadius, cv::Mat &output) {
	 ...
	 * @param output The image in which to store the output.
	 */
	void TestPipeline::hsvThreshold(cv::Mat &input, double hue[], double sat[], double val[], cv::Mat &out) {
	 ...
	 */
	void TestPipeline::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void TestPipeline::convexHulls(std::vector<std::vector<cv::Point> > &inputContours, std::vector<std::vector<cv::Point> > &outputContours) {
